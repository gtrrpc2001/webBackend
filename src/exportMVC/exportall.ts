...
import { Hospital_patientModule } from "src/module/hospital_patient.module";
...
export class allModule {
    ...
    static appImport = [
        ...
        parentsModule, ecg_byteModule, appversionModule, smsModule, app_logModule, app_bleModule, ecg_stressModule, Hospital_patientModule
